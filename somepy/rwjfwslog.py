...
infile = '/Users/cwen/development/doc/RWJF_project/phase_2/log_for_josh/rwjfwsAccess.log'
outfile = '/Users/cwen/development/doc/RWJF_project/phase_2/log_for_josh/rwjfws.processed.log'
outcheckfile = '/Users/cwen/development/doc/RWJF_project/phase_2/log_for_josh/checkMappingRWJFWS.log'
nosidfile = '/Users/cwen/development/doc/RWJF_project/phase_2/log_for_josh/nosidRWJFWS.log'
                ...
                while line:
                    if 'mrn=' in line:
                        ...
                        try:
                            ...
                            nosid_f.write('%s \n' % (mrn_log))
                    if 'RwjfUIController.showRWJFBatch accessed --' in line:
                        out_f.write(line)
                    line = f.readline()